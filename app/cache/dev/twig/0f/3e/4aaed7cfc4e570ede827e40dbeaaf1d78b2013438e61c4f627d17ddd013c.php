...
class __TwigTemplate_0f3e4aaed7cfc4e570ede827e40dbeaaf1d78b2013438e61c4f627d17ddd013c extends Twig_Template
{
...
var componentUrlBase = \"";
        // line 30
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("reader_components", array("book" => "bookId", "component" => "componentId")), "html", null, true);
        echo "\";
//alert(componentUrl);
  ...
  getComponents: function () {
    return [
      ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["book"]) ? $context["book"] : $this->getContext($context, "book")), "getComponents"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["component"]) {
            ...
            if ((!$this->getAttribute((isset($context["loop"]) ? $context["loop"] : $this->getContext($context, "loop")), "last"))) {
                // line 53
                echo "\t\t\t'";
                echo twig_escape_filter($this->env, (isset($context["component"]) ? $context["component"] : $this->getContext($context, "component")), "html", null, true);
                echo "',
\t\t";
            } else {
                // line 55
...
\t\t";
  ...
  getComponent: function (componentId) {
    return getBookComponent('";
        // line 77
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["book"]) ? $context["book"] : $this->getContext($context, "book")), "bookId"), "html", null, true);
        echo "', componentId);
  },
...
function getBookComponent(bookId, componentId) {
\tcomponentUrl = componentUrlBase.replace('bookId',bookId).replace('componentId',componentId);
\tvar response = \$.ajax({
\t\ttype: \"GET\",
\t\turl: componentUrl,
...
";
    ...
    {
        return "PosdtaSiteBundle:Reader:index.html.twig";
    }
    ...
    {
        return array (  269 => 129,  214 => 77,  193 => 58,  179 => 57,  173 => 55,  167 => 53,  164 => 52,  147 => 51,  123 => 30,  115 => 24,  89 => 22,  85 => 18,  82 => 17,  50 => 15,  46 => 10,  43 => 9,  29 => 7,  25 => 6,  19 => 2,);
    }
}
